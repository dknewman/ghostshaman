      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            <Image src="/assets/logo.svg" alt="GhostShaman" width={200} height={34} className="mb-4" />
          ...
          <div>
            <h4 className="font-display text-xs text-[#39ff14] tracking-widest mb-4">NAVIGATE</h4>
          ...
          <div>
            <h4 className="font-display text-xs text-[#39ff14] tracking-widest mb-4">LEGAL</h4>
            <ul className="space-y-2">
            ...
            <h4 className="font-display text-xs text-[#39ff14] tracking-widest mt-6 mb-4">CONTACT</h4>
