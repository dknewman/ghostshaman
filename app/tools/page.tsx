  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12">
      ...
      <div className="border border-[#1f1f1f] rounded bg-[#0d0d0d] p-8 text-center">
        <div className="w-12 h-12 rounded-full border border-[#547A0055] flex items-center justify-center mx-auto mb-4">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#7FAF16" strokeWidth="2">
