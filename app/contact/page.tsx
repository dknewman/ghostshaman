      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          <div className="border border-[#1f1f1f] rounded bg-[#111] p-6 space-y-5">
            <h3 className="font-display text-xs text-[#39ff14] tracking-widest">OTHER WAYS TO CONNECT</h3>
            {[
              ...
              <div key={item.label} className="border-t border-[#1f1f1f] pt-4 first:border-0 first:pt-0">
                <p className="font-display text-[10px] tracking-widest text-[#39ff14] mb-1">{item.label}</p>
                <a href={`mailto:${item.email}`} className="text-white text-sm hover:text-[#39ff14] transition-colors">{item.email}</a>
          ...
          <div className="border border-[#1f1f1f] rounded bg-[#111] p-6">
            <h3 className="font-display text-xs text-[#39ff14] tracking-widest mb-4">FOLLOW THE HUNT</h3>
